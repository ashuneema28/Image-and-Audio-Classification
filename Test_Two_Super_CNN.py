...
directory_path = 'C:/Project1/.idea/DONE and DUSTED/TWO_SUPER_CNN/ONE_SUPER_CNN.tfl'

def load_CNN_TWO_SUPER(path):
...
two_super_cnn_model = load_CNN_TWO_SUPER(directory_path)
...
valid_d = load("C:/Project1/.idea/DONE and DUSTED/TWO_SUPER_CNN/train_pre_processed_data_two_super_CNN.pck")
...
if __name__ == '__main__':
    print('One Super CNN accuracy = {}'.format(test_tflearn_cnn_model(two_super_cnn_model, input_valid_d, label_valid_d)))
