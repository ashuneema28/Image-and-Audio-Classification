...
train_d = load("train_pre_processed_data_BUZZ3.pck")
test_d = load("test_pre_processed_data_BUZZ3.pck")
...
SAVE_BUZZ1_CNN_PATH = 'C:/Project1/.idea/DONE and DUSTED/BUZZ1_CNN/BUZZ1_CNN2.tfl'
MODEL.save(SAVE_BUZZ1_CNN_PATH)