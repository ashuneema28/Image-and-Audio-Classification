...
directory_path = 'C:/Project1/.idea/DONE and DUSTED/BUZZ2_ANN/BUZZ2_ANN.tfl'

def load_ann_BUZZ2(path):
...
buzz2_ann_model = load_ann_BUZZ2(directory_path)
...
valid_d = load("C:/Project1/.idea/DONE and DUSTED/BUZZ2_ANN/test_pre_processed_data_BUZZ2.pck")
...
if __name__ == '__main__':
    print('Buzz2 ANN accuracy = {}'.format(test_tflearn_ann_model(buzz2_ann_model, input_valid_d, label_valid_d)))
