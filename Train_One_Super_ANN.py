...
path= "C:/Project1/.idea/DONE and DUSTED/ONE_SUPER_ANN/"

train_d = load("train_pre_processed_data_one_super.pck")
test_d = load("test_pre_processed_data_one_super.pck")
valid_d = load("valid_pre_processed_data_one_super.pck")
...
SAVE_BEE1_ANN_PATH = 'C:/Project1/.idea/DONE and DUSTED/ONE_SUPER_ANN/ONE_SUPER_ANN2.tfl'
MODEL.save(SAVE_BEE1_ANN_PATH)

print(MODEL.predict(input_train_d[0].reshape([-1, 90, 90, 1])))