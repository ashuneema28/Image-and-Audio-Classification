...
directory_path = 'C:/Project1/.idea/DONE and DUSTED/BUZZ2_CNN/BUZZ2_CNN.tfl'

def load_cnn_BUZZ2(path):
...
buzz2_cnn_model = load_cnn_BUZZ2(directory_path)
...
valid_d = load("C:/Project1/.idea/DONE and DUSTED/BUZZ2_CNN/test_pre_processed_data_BUZZ2.pck")
...
if __name__ == '__main__':
    print('Buzz2 CNN accuracy = {}'.format(test_tflearn_ann_model(buzz2_cnn_model, input_valid_d, label_valid_d)))
