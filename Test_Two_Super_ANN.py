...
directory_path = 'C:/Project1/.idea/DONE and DUSTED/TWO_SUPER_ANN/TWO_SUPER_ANN.tfl'

def load_ann_Two_Super(path):
...
two_super_ann_model = load_ann_Two_Super(directory_path)
...
valid_d = load("C:/Project1/.idea/DONE and DUSTED/TWO_SUPER_ANN/valid_pre_processed_data_two_super_ANN.pck")
...
if __name__ == '__main__':
    print('Two Super ANN accuracy = {}'.format(test_tflearn_ann_model(two_super_ann_model, input_valid_d, label_valid_d)))
