...
train_d = load("train_pre_processed_data_two_super_CNN.pck")
test_d = load("test_pre_processed_data_two_super_CNN.pck")
valid_d = load("valid_pre_processed_data_two_super_CNN.pck")
...
SAVE_BEE1_ANN_PATH = 'C:/Users/A02290684/Desktop/Intelligent systems/Project1/.idea/TWO_SUPER_CNN/ONE_SUPER_CNN.tfl'
