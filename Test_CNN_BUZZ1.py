...
directory_path = 'C:/Project1/.idea/DONE and DUSTED/BUZZ1_CNN/BUZZ1_CNN.tfl'

def load_cnn_BUZZ1(path):
...
buzz1_cnn_model = load_cnn_BUZZ1(directory_path)
...
valid_d = load("C:/Project1/.idea/DONE and DUSTED/BUZZ1_CNN/valid_pre_processed_data_BUZZ1_2.pck")
...
if __name__ == '__main__':
    print('Buzz1 ANN accuracy = {}'.format(test_tflearn_ann_model(buzz1_cnn_model, input_valid_d, label_valid_d)))
